...
CREATE TABLE PRODUCTO (
		ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_87C11B49_1CAD_4215_94ED_A89403187491) NOT NULL,
		NOMBRE VARCHAR(200),
...
CREATE UNIQUE INDEX PRIMARY_KEY_F ON PRODUCTO (ID ASC);

ALTER TABLE PRODUCTO ADD CONSTRAINT CONSTRAINT_F PRIMARY KEY (ID);
